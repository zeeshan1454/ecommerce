...
if (isset($_REQUEST['uniqid'])) {
    ...
    $sel = "SELECT * FROM `invoice_tbl` WHERE `agent_name`='0000000' ORDER BY id DESC LIMIT 1";
}
...
if (isset($_POST['passenger_details']) || isset($_POST['send_save'])) {
    ...
    if (!empty($name) && !empty($email) && !empty($mobile)) {
        ...
        if ($run) {
            ...
            $_SESSION['error'] = '<b> Error! Passenger Info Failed! Try Again!! </b>';
        }
    } else {
                                    ...
                                    <div class="row append_passsnger">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group-icon">
                                                    <input type="<?php if (!empty($row['p_mobile_a'])) {
                                                        ...
                                                        echo "text";
                                                    } ?>" class="form-control" placeholder="Alternate Phone Number"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group-icon">
                                                    <input type="date" class="form-control birthday" name="dob"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group-icon">
                                                    <input type="text" class="form-control" name="p_billing_address"
